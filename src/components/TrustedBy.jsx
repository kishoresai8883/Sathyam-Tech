...
const TrustedBy = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='flex flex-col items-center px-4 py-4 sm:px-12 lg:px-24 xl:px-40
      ...
      <motion.div
        ...
        {company_logos.map((logo, index) => (
            <motion.img
              ...
              src={logo} key={index} alt="logos" className='max-h-5 sm:max-h-6 dark:drop-shadow-xl' />
        ))}
      </motion.div>
    </motion.div>
  )
