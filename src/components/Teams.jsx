...
const Teams = () => {
  return (
    ...
    lg:px-24 xl:px-40 pt-28 text-gray-800 dark:text-white'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5'>
        {teamData.map((team, index)=> (
            ...
            hover:scale-102 transition-all duration-400'>
                <img src={team.image} alt="Teams" className='h-12 w-12 rounded-full'/>
